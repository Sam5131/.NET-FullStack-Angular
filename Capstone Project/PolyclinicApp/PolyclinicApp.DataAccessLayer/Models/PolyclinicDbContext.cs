...
public partial class PolyclinicDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(da => new { da.PatientId, da.DoctorName, da.AppointmentNo })
                  .HasName("pk_DoctorAppointment");
        });
    ...
    public static decimal ufn_CalcualteDoctorFees(string doctorId, DateTime date)
    {
        return 0;
    }
